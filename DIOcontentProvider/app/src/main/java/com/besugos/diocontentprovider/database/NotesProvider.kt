package com.besugos.diocontentprovider.database
...
import com.besugos.diocontentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.besugos.diocontentprovider.provider"

        val BASE_URI = Uri.parse("content://$AUTHORITY")
        val URI_NOTES = Uri.withAppendedPath(BASE_URI, "notes")

        // "content://com.besugos.diocontentprovider/notes"
